...
!function(t) {
    ...
    var a = function(i) {
        var n = typeof i,
            ...
            a = t(".no-js");
        if (s.length || t('<meta class="foundation-mq">').appendTo(document.head), a.length && a.removeClass("no-js"), "undefined" === n)
            o.MediaQuery._init(),
            o.reflow(this);
        else {
            if ("string" !== n)
...
!function(t) {
    function e(t, e, i) {
        function n(r) {
            ...
            o = r - a,
            i.apply(e),
            o < t ? s = window.requestAnimationFrame(n, e) : (window.cancelAnimationFrame(s), e.trigger("finished.zf.animate", [e]).triggerHandler("finished.zf.animate", [e]))
        }
        var s,
            o,
            a = null;
        ...
        return _createClass(e, [{
            ...
            value: function() {
                ...
                this.$element.find("li").each(function() {
                    ...
                    a.each(function(e) {
                        if (t(this).is(o))
                            return n = a.eq(Math.max(0, e - 1)).find("a").first(), s = a.eq(Math.min(e + 1, a.length - 1)).find("a").first(), t(this).children("[data-submenu]:visible").length && (s = o.find("li:first-child").find("a").first()),
                            t(this).is(":first-child") ? n = o.parents("li").first().find("a").first() : n.parents("li").first().children("[data-submenu]:visible").length && (n = n.parents("li").find("li:last-child").find("a").first()), void (t(this).is(":last-child") && (s = o.parents("li").first().next("li").find("a").first()))
                    }),
    ...
    var e = function() {
        ...
        return _createClass(e, [{
                    ...
                    Foundation.Keyboard.handleKey(i, "Drilldown", {
                        next: function() {
                            if (o.is(e.$submenuAnchors))
                                return e._show(o.parent("li")), o.parent("li").one(Foundation.transitionend(o), function() {
            ...
            value: function(t) {
                ...
                t.attr("aria-hidden", !0).addClass("is-closing").one(Foundation.transitionend(t), function() {
                    t.removeClass("is-active is-closing"),
                    t.blur()
                }),
            ...
            value: function() {
                var e = this,
                    ...
                    s = function(s) {
                        ...
                        if (!a)
                            return void (e.options.closeOnClickInside && e._hide(o));
                        if (r) {
        ...
        return _createClass(e, [{
            ...
            value: function(e, i) {
                if (!this.$element.hasClass("is-open") && !this.isRevealed) {
                    ...
                    s.addClass("is-off-canvas-open is-open-" + n.options.position),
                    ...
                    this.options.autoFocus && s.one(Foundation.transitionend(s), function() {
            ...
            value: function() {
                ...
                t.off(".zf.offcanvas").on("keydown.zf.offcanvas", function(t) {
                    ...
                    "TAB" === n && t.target === i[0] && (t.preventDefault(), e.focus()),
                    "SHIFT_TAB" === n && t.target === e[0] && (t.preventDefault(), i.focus())
                })
            }
        }, {
            key: "close",
    ...
    var e = function() {
        ...
        return _createClass(e, [{
            ...
            value: function(t, e, i) {
                ...
                s.length && (this.$element.trigger("beforeslidechange.zf.orbit", [n, s]), this.options.bullets && (i = i || this.$slides.index(s), this._updateBullets(i)), this.options.useMUI ? (Foundation.Motion.animateIn(s.addClass("is-active").css({
                    position: "absolute",
                    top: 0
        ...
        return _createClass(i, [{
            ...
            value: function(t) {
                ...
                if ("none" == this.$element.css("display") && (s = 0), this.containerHeight = s, this.$container.css({
                    height: s
                }), this.elemHeight = s, this.isStuck)
                    this.$element.css({
            ...
            value: function(t, i) {
                ...
                "top" === this.options.stickTo ? (o -= n, a -= t + n) : "bottom" === this.options.stickTo && (o -= r - (t + s), a -= r - s),
                this.topPoint = o,
                this.bottomPoint = a,
                i && "function" == typeof i && i()
            }
            ...
            value: function() {
                ...
                this.$tabTitles.off("keydown.zf.tabs").on("keydown.zf.tabs", function(i) {
                    if (9 !== i.which) {
                        ...
                        a.each(function(i) {
                            if (t(this).is(o))
                                return void (e.options.wrapOnKeys ? (n = 0 === i ? a.last() : a.eq(i - 1), s = i === a.length - 1 ? a.first() : a.eq(i + 1)) : (n = a.eq(Math.max(0, i - 1)), s = a.eq(Math.min(i + 1, a.length - 1))))
                        }),
