!function(e, t) {
	...
	function n(e) {
		var t = o(e),
			...
			d = w[e.type];
		"pointer" === d && (d = i(e)),
		p !== d && (!y && p && "keyboard" === d && "tab" !== v[t] && m.indexOf(n.nodeName.toLowerCase()) >= 0 || (p = d, a.setAttribute("data-whatinput", p), -1 === h.indexOf(p) && h.push(p))),
		"keyboard" === d && u(t)
	}
	function o(e) {
	...
	return function() {
		...
		"ontouchstart" in document.documentElement && a.addEventListener("touchstart", e),
